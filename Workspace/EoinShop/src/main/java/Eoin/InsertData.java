...
public class InsertData extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			connect = DriverManager.getConnection("jdbc:mysql://localhost/Eoin","root" ,"" );
			...
			String sql = "INSERT INTO products (id, producttype, productname, price, qty, img) VALUES" +
		    		"(101,'Hoodie', 'lind constellation hoodie', 60, 1000, '/img/lind-hoodie.png'),"+
		    		"(102,'T-Shirt', 'lind constellation tee i', 35, 1000, '/img/lind-t-i.png'),"+
		    		"(103,'Accessory', 'lind constellation tee ii', 35, 1000, '/img/lind-t-ii.png'),"+
		    		"(104,'Misc', 'Love Is Not Dying Poster', 25, 1000, '/img/lind-poster.png')," +
