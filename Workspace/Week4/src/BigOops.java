...
public class BigOops extends Frame  
{  
...
///////////////////////////  
BigOops(String frameText)//constructor  
{  
super(frameText);  
...
{  
new BigOops("Calculator - JavaTpoint");  
}  
}  
...
//////////////////////////////////////////  
MyDigitButton(int x,int y, int width,int height,String cap, BigOops clc)  
{  
super(cap);  
...
MyOperatorButton(int x,int y, int width,int height,String cap, BigOops clc)  
{  
super(cap);  
setBounds(x,y,width,height);  
this.cl=clc;  
...
if(opText.equals("1/x"))  
    ...
    try  
        ...
        cl.displayLabel.setText(BigOops.getFormattedText(tempd));}  
...
cl.displayLabel.setText(BigOops.getFormattedText(temp));  
//cl.number=temp;  
}//actionPerformed  
}//class  
...
/////////////////////////////////  
MyMemoryButton(int x,int y, int width,int height,String cap, BigOops clc)  
{  
super(cap);  
setBounds(x,y,width,height);  
this.cl=clc;  
...
case 'R':   
    cl.displayLabel.setText(BigOops.getFormattedText(cl.memValue));break;  
case 'S':  
    cl.memValue=0.0;  
case '+':   
...
MySpecialButton(int x,int y, int width,int height,String cap, BigOops clc)  
{  
super(cap);  
setBounds(x,y,width,height);  
this.cl=clc;  
